    ...
    return (
        <div className="space-y-8 animate-fade-in max-w-4xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            value={user.name}
                            readOnly
                            className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2.5 text-slate-300 focus:outline-none cursor-not-allowed opacity-75"
                        />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="bg-slate-950 border border-slate-800 rounded-lg px-4 py-2.5 text-slate-300 capitalize flex items-center justify-between">
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-slate-950/50 rounded-lg">
                        ...
                        <button
                            ...
                            className={`w-12 h-6 rounded-full transition-colors relative ${notificationsEnabled ? 'bg-primary' : 'bg-slate-700'}`}
                        >
                    ...
                    <div className="flex items-center justify-between p-4 bg-slate-950/50 rounded-lg">
                        ...
                        <button
                            ...
                            className={`w-12 h-6 rounded-full transition-colors relative ${emailUpdates ? 'bg-primary' : 'bg-slate-700'}`}
                        >
            ...
            <section className="bg-slate-900 border border-slate-800 rounded-xl p-6">
                ...
                <div className="flex items-center justify-between p-4 bg-slate-950/50 rounded-lg">
                    ...
                    <button
                        ...
                        className={`w-12 h-6 rounded-full transition-colors relative ${darkMode ? 'bg-primary' : 'bg-slate-700'}`}
                    >
            ...
            <section className="bg-slate-900 border border-slate-800 rounded-xl p-6">
                ...
                <button className="w-full bg-slate-950 border border-slate-800 hover:border-primary/50 text-slate-300 py-3 rounded-lg transition-all flex items-center justify-between px-4 group">
