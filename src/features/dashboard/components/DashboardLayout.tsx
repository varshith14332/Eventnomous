                    ...
                    <div className="flex items-center gap-4 ml-auto">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="p-2 text-slate-400 hover:bg-slate-800 rounded-full relative transition-colors focus:outline-none focus:bg-slate-800"
                            >
                            ...
                            {isNotificationsOpen && (
                                <div className="absolute right-0 mt-2 w-80 bg-slate-900 border border-slate-800 rounded-xl shadow-xl z-50 animate-fade-in origin-top-right">
                                    ...
                                    <div className="max-h-80 overflow-y-auto">
                                        {notifications.map((notification) => (
                                            <div
                                                ...
                                                className={cn(
                                                    "p-4 border-b border-slate-800/50 hover:bg-slate-800/50 transition-colors cursor-pointer",
                                    ...
                                    <div className="p-3 bg-slate-950/50 rounded-b-xl text-center">
                                        <button
                                            onClick={() => {
                                                setNotificationsOpen(false);
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="h-9 w-9 rounded-full bg-slate-800 flex items-center justify-center hover:bg-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50"
                            >
                                <User className="h-5 w-5 text-slate-400" />
                            </button>

                            {isUserMenuOpen && (
                                <div className="absolute right-0 mt-2 w-56 bg-slate-900 border border-slate-800 rounded-xl shadow-xl z-50 animate-fade-in origin-top-right">
